<?php 
  ...
  $is_prod = in_array($_SERVER['HTTP_HOST'], array('www.ebi.ac.uk', 'intranet.ebi.ac.uk', 'staff.ebi.ac.uk'), TRUE);
  ...
  function tidy($buffer, $is_admin, $is_prod) {
...
<!-- END: default Drupal Head Metatags -->
  ...
  <?php print (tidy($scripts, $is_admin, $is_prod)); ?>
  <?php if (ebicompliance_get_subpath() === 'pdbe'): ?>
    <script type="text/javascript" src="/pdbe/js/pdbe_main.js"></script>
  <?php endif; ?>
...
<!-- page_top -->
    <?php print(tidy($page_top, $is_admin, $is_prod)); ?>
<!-- page -->
    <?php print(tidy($page, $is_admin, $is_prod)); ?>
<!-- page_bottom -->
    <?php print(tidy($page_bottom, $is_admin, $is_prod)); ?>
